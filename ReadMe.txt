...
1. Unzip the "extra assemblies" lib.zip file and place the dll files in the \Trunk\src\Lib folder.

2. Open the \Trunk\src\Graffiti.sln file with Visual studio 2008.
...
6. Setup the database using the instructions in the \Trunk\data\read_me.txt file.
