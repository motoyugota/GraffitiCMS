...
{
    [Serializable]
    public class DataRoleCategoryPermissions : DataBuddyBase 
    {
        private static readonly Table _Table = null;

        static DataRoleCategoryPermissions() {
        ...
        /// </summary>
        public static DataRoleCategoryPermissions FetchByColumn(Column column, object value) {
            Query q = new Query(_Table);
            q.AndWhere(column, value);
            return FetchByQuery(q);
        }

        public static DataRoleCategoryPermissions FetchByQuery(Query q) {
            DataRoleCategoryPermissions item = new DataRoleCategoryPermissions();
        ...
        public DataRoleCategoryPermissions() { }
        /// <summary>
        /// Loads an instance of RoleCategoryPermissions for the supplied primary key value
        /// </summary>
        public DataRoleCategoryPermissions(object keyValue) {
            Query q = new Query(_Table);
        ...
        public static int Destroy(Column column, object value) {
            DataRoleCategoryPermissions objectToDelete = FetchByColumn(column, value);
