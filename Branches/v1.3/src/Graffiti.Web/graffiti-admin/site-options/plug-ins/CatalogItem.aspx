<%@ Page Language="C#" MasterPageFile="~/graffiti-admin/common/AdminModal.master" AutoEventWireup="true" CodeBehind="CatalogItem.aspx.cs" Inherits="graffiti_admin_presentation_plugins_CatalogItem" Title="Plugin Marketplace" %>
...
<div id="messages_form">
    ...
    <Z:Breadcrumbs runat="server" SectionName="PluginMarketplace" />
    ...
    <div class="submit">
        <div id="buttons">
            <asp:Button ID="InstallButton" runat="server" Text="Install Plugin" OnClick="Install_Click" />
            <asp:Button ID="DownloadButton" runat="server" Text="Download Plugin" OnClientClick="downloadItem(); return false;" />
            <asp:Button ID="BuyButton" runat="server" Text="Buy Plugin" OnClientClick="buyItem(); return false;" />
