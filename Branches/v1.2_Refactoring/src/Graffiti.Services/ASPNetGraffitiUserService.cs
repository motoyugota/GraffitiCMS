...
{
    public class ASPNetGraffitiUserController : IGraffitiUserService
    {
        ...
        {
            throw new NotImplementedException("The ASPNetGraffitiUserController does not support retrieving users by Int Id - use Guid instead.");
        }
        ...
        public IGraffitiUser GetUser(Guid id)
        {
            ...
            if (mu == null)
                throw new Exception("Membership User Does not Exist for " + id);
