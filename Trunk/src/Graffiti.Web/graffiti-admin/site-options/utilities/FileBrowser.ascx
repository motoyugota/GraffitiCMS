...
// <!--
	...
	window._fileBrowserSelectFileFunction = <%= OnClientFileClickedFunction %>;
	...
	<%= EnableResizeToHeight ? "window.setTimeout(resizeHeight, 499);" : "" %>
