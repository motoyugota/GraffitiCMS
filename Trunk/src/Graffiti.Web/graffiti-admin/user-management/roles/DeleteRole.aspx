...
{
    GraffitiUsers.DeleteRole(Request.QueryString["role"]);
...
<div class="ModalFormBlock">
    ...
    <p>This role will be permanently deleted. Any users that were in this role will have their permissions removed.</p>
    </asp:PlaceHolder>
