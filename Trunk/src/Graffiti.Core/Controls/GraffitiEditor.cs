...
namespace Graffiti.Core
{
	public class GraffitiEditor : UserControl, ITextControl, IPostBackDataHandler
	{
		...
		protected static string _filebrowserUrl =
			VirtualPathUtility.ToAbsolute("~/graffiti-admin/site-options/utilities/EditorFileSelector.aspx") +
			"?path=files\\\\media";

		protected string _text = string.Empty;


		public static string CkEditorJS
		{
			get { return _ckEditorJS; }
			set { _ckEditorJS = value; }
		}

		public static string FilebrowserUrl
		{
			get { return _filebrowserUrl; }
			set { _filebrowserUrl = value; }
		}
		...
		/// </summary>
		public string ExternalConfigJs
		{
			get { return (string) ViewState["exCfg"]; }
			set { ViewState["exCfg"] = value; }
		}
		...
		{
			get { return (string) ViewState["extraCfg"]; }
			set { ViewState["extraCfg"] = value; }
		}
		...
		{
			get { return (string) ViewState["lang"]; }
		...
		{
			get { return (LanguageDir) GetVstate("ldr", LanguageDir.ltr); }
			set { ViewState["ldr"] = value; }
		}
		...
		{
			get { return (string) ViewState["exPlug"]; }
			set { ViewState["exPlug"] = value; }
		}

		public string EditorSkin
		{
			get { return (string) ViewState["skin"]; }
		...
		/// </summary>
		public string EditorContentCss
		{
			get { return (string) ViewState["eccss"]; }
			set { ViewState["eccss"] = value; }
		}
		...
		{
			get { return (string) ViewState["bcu"]; }
			set { ViewState["bcu"] = value; }
		}

		public bool Resizable
		{
			get { return (bool) GetVstate("cRz", true); }
			set { ViewState["cRz"] = value; }
		}

		/// <summary>
		///     Whether to enable the "More Colors..." button in the color selectors.
		/// </summary>
		public bool EnableMoreColors
		{
			get { return (bool) GetVstate("emclr", true); }
			set { ViewState["emclr"] = value; }
		}
		...
		{
			get { return (bool) GetVstate("fcePPlain", false); }
			set { ViewState["fcePPlain"] = value; }
		}

		/// <summary>
		///     Whether the "Ignore font face definitions" checkbox is enabled by default in the Paste from Word dialog.
		/// </summary>
		public bool PastFromWordIgnoreFontFace
		{
			get { return (bool) GetVstate("pfwordigff", false); }
			set { ViewState["pfwordigff"] = value; }
		}
		...
		/// </summary>
		public bool PasteFromWordKeepsStructure
		{
			get { return (bool) GetVstate("pfwordkpstr", false); }
			set { ViewState["pfwordkpstr"] = value; }
		}

		/// <summary>
		///     Whether the "Remove styles definitions" checkbox is enabled by default in the Paste from Word dialog.
		/// </summary>
		public bool PasteFromWordRemoveStyle
		{
			get { return (bool) GetVstate("pfwordremst", false); }
			set { ViewState["pfwordremst"] = value; }
		}

		public Unit Width
		{
			get { return (Unit) GetVstate("w", new Unit()); }
			set { ViewState["w"] = value; }
		}

		public Unit Height
		{
			get { return (Unit) GetVstate("h", new Unit()); }
			set { ViewState["h"] = value; }
		}

		public int MinWidth
		{
			get { return (int) GetVstate("miW", -1); }
			set { ViewState["miW"] = value; }
		}

		public int MaxWidth
		{
			get { return (int) GetVstate("maW", -1); }
			set { ViewState["maW"] = value; }
		}

		public int MinHeight
		{
			get { return (int) GetVstate("miH", -1); }
			set { ViewState["miH"] = value; }
		}

		public int MaxHeight
		{
			get { return (int) GetVstate("maH", -1); }
			set { ViewState["maH"] = value; }
		}
		...
		{
			get { return (int) GetVstate("pzi", -1); }
			set { ViewState["pzi"] = value; }
		}
		...
		/// </summary>
		public Color DialogCoverBackground
		{
			get { return (Color) GetVstate("dbgc", Color.Transparent); }
			set { ViewState["dbgc"] = value; }
		}
		...
		/// </summary>
		public string DialogCoverTransparency
		{
			get { return (string) ViewState["dbgt"]; }
			set { ViewState["dbgt"] = value; }
		}

		/// <summary>
		///     Whether the toolbar can be collapsed by the user. If disabled, the collapser button will not be displayed.
		/// </summary>
		public bool CanCollapseToolbar
		{
			get { return (bool) GetVstate("canClpsTb", true); }
			set { ViewState["canClpsTb"] = value; }
		}
		...
		{
			get { return (bool) GetVstate("tbsex", true); }
			set { ViewState["tbsex"] = value; }
		}

		public string ToolbarSet
		{
			get { return (string) ViewState["tb"]; }
			set { ViewState["tb"] = value; }
		}
		...
		protected virtual string innerBuildConfigOptions()
		{
			...
			if (DialogCoverBackground != Color.Transparent)
				setupConfigParam(buff, "dialog_backgroundCoverColor",
				                 string.Format("rgb({0},{1},{2})", DialogCoverBackground.R, DialogCoverBackground.G,
				                               DialogCoverBackground.B), true);
