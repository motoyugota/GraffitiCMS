...
namespace Graffiti.Core
{
	...
	public partial class Category : DataBuddyBase
	{
		...
		static Category()
		{
			...
			_Table.Columns.Add(new Column("Id", DbType.Int32, typeof (Int32), "Id", false, true));
			_Table.Columns.Add(new Column("Name", DbType.String, typeof (String), "Name", false, false));
			_Table.Columns.Add(new Column("View", DbType.String, typeof (String), "View", false, false));
			_Table.Columns.Add(new Column("PostView", DbType.String, typeof (String), "PostView", false, false));
			_Table.Columns.Add(new Column("FormattedName", DbType.String, typeof (String), "FormattedName", false, false));
			_Table.Columns.Add(new Column("LinkName", DbType.String, typeof (String), "LinkName", false, false));
			_Table.Columns.Add(new Column("FeedUrlOverride", DbType.String, typeof (String), "FeedUrlOverride", true,
			                              false));
			_Table.Columns.Add(new Column("Body", DbType.String, typeof (String), "Body", true, false));
			_Table.Columns.Add(new Column("IsDeleted", DbType.Boolean, typeof (Boolean), "IsDeleted", false, false));
			_Table.Columns.Add(new Column("Post_Count", DbType.Int32, typeof (Int32), "PostCount", false, false));
			_Table.Columns.Add(new Column("UniqueId", DbType.Guid, typeof (Guid), "UniqueId", false, false));
			_Table.Columns.Add(new Column("ParentId", DbType.Int32, typeof (Int32), "ParentId", false, false));
			_Table.Columns.Add(new Column("Type", DbType.Int32, typeof (Int32), "Type", false, false));
			_Table.Columns.Add(new Column("ImageUrl", DbType.String, typeof (String), "ImageUrl", true, false));
			_Table.Columns.Add(new Column("MetaDescription", DbType.String, typeof (String), "MetaDescription", true,
			                              false));
			_Table.Columns.Add(new Column("MetaKeywords", DbType.String, typeof (String), "MetaKeywords", true, false));
			_Table.Columns.Add(new Column("FeaturedId", DbType.Int32, typeof (Int32), "FeaturedId", false, false));
			_Table.Columns.Add(new Column("SortOrderTypeId", DbType.Int32, typeof (Int32), "SortOrderTypeId", false, false));
			_Table.Columns.Add(new Column("ExcludeSubCategoryPosts", DbType.Boolean, typeof (Boolean),
			                              "ExcludeSubCategoryPosts", false, false));
		}
		...
		private void Load(IDataReader reader, bool close)
		{
			Id = DataService.GetValue<Int32>(Columns.Id, reader);
			Name = DataService.GetValue<String>(Columns.Name, reader);
			View = DataService.GetValue<String>(Columns.View, reader);
			PostView = DataService.GetValue<String>(Columns.PostView, reader);
			FormattedName = DataService.GetValue<String>(Columns.FormattedName, reader);
			LinkName = DataService.GetValue<String>(Columns.LinkName, reader);
			FeedUrlOverride = DataService.GetValue<String>(Columns.FeedUrlOverride, reader);
			Body = DataService.GetValue<String>(Columns.Body, reader);
			IsDeleted = DataService.GetValue<Boolean>(Columns.IsDeleted, reader);
			PostCount = DataService.GetValue<Int32>(Columns.PostCount, reader);
			UniqueId = DataService.GetValue<Guid>(Columns.UniqueId, reader);
			ParentId = DataService.GetValue<Int32>(Columns.ParentId, reader);
			Type = DataService.GetValue<Int32>(Columns.Type, reader);
			ImageUrl = DataService.GetValue<String>(Columns.ImageUrl, reader);
			MetaDescription = DataService.GetValue<String>(Columns.MetaDescription, reader);
			MetaKeywords = DataService.GetValue<String>(Columns.MetaKeywords, reader);
			FeaturedId = DataService.GetValue<Int32>(Columns.FeaturedId, reader);
			SortOrderTypeId = DataService.GetValue<Int32>(Columns.SortOrderTypeId, reader);
			ExcludeSubCategoryPosts = DataService.GetValue<Boolean>(Columns.ExcludeSubCategoryPosts, reader);
			Loaded();
			ResetStatus();
		...
		{
			var parameters = new List<Parameter>(Table.Columns.Count);
		...
		private String _FeedUrlOverride;

		public String FeedUrlOverride
		{
			get { return _FeedUrlOverride; }
			set
			{
				MarkDirty();
				_FeedUrlOverride = value;
			}
		}
		...
		private Int32 _FeaturedId;

		public Int32 FeaturedId
		{
		...
		private Int32 _SortOrderTypeId;

		public Int32 SortOrderTypeId
		{
			get { return _SortOrderTypeId; }
			set
			{
				MarkDirty();
				_SortOrderTypeId = value;
			}
		}
		...
		private Boolean _ExcludeSubCategoryPosts;

		public Boolean ExcludeSubCategoryPosts
		{
			get { return _ExcludeSubCategoryPosts; }
			set
			{
				MarkDirty();
				_ExcludeSubCategoryPosts = value;
			}
		}
		...
		{
			public static readonly Column Id = new Column("Id", DbType.Int32, typeof (Int32), "Id", false, true);
			public static readonly Column Name = new Column("Name", DbType.String, typeof (String), "Name", false, false);
			public static readonly Column View = new Column("View", DbType.String, typeof (String), "View", false, false);

			public static readonly Column PostView = new Column("PostView", DbType.String, typeof (String), "PostView",
			                                                    false, false);

			public static readonly Column FormattedName = new Column("FormattedName", DbType.String, typeof (String),
			                                                         "FormattedName", false, false);

			public static readonly Column LinkName = new Column("LinkName", DbType.String, typeof (String), "LinkName",
			                                                    false, false);

			public static readonly Column FeedUrlOverride = new Column("FeedUrlOverride", DbType.String, typeof (String),
			                                                           "FeedUrlOverride", true, false);

			public static readonly Column Body = new Column("Body", DbType.String, typeof (String), "Body", true, false);

			public static readonly Column IsDeleted = new Column("IsDeleted", DbType.Boolean, typeof (Boolean),
			                                                     "IsDeleted", false, false);

			public static readonly Column PostCount = new Column("Post_Count", DbType.Int32, typeof (Int32), "PostCount",
			                                                     false, false);

			public static readonly Column UniqueId = new Column("UniqueId", DbType.Guid, typeof (Guid), "UniqueId", false,
			                                                    false);

			public static readonly Column ParentId = new Column("ParentId", DbType.Int32, typeof (Int32), "ParentId",
			                                                    false, false);

			public static readonly Column Type = new Column("Type", DbType.Int32, typeof (Int32), "Type", false, false);

			public static readonly Column ImageUrl = new Column("ImageUrl", DbType.String, typeof (String), "ImageUrl",
			                                                    true, false);

			public static readonly Column MetaDescription = new Column("MetaDescription", DbType.String, typeof (String),
			                                                           "MetaDescription", true, false);

			public static readonly Column MetaKeywords = new Column("MetaKeywords", DbType.String, typeof (String),
			                                                        "MetaKeywords", true, false);

			public static readonly Column FeaturedId = new Column("FeaturedId", DbType.Int32, typeof (Int32), "FeaturedId",
			                                                      false, false);

			public static readonly Column SortOrderTypeId = new Column("SortOrderTypeId", DbType.Int32, typeof (Int32),
			                                                           "SortOrderTypeId", false, false);

			public static readonly Column ExcludeSubCategoryPosts = new Column("ExcludeSubCategoryPosts", DbType.Boolean,
			                                                                   typeof (Boolean), "ExcludeSubCategoryPosts",
			                                                                   false, false);
		}
	}
	...
	public partial class Comment : DataBuddyBase
	{
		...
		static Comment()
		{
			...
			_Table.PrimaryKey = "Id";
			_Table.Columns.Add(new Column("Id", DbType.Int32, typeof (Int32), "Id", false, true));
			_Table.Columns.Add(new Column("PostId", DbType.Int32, typeof (Int32), "PostId", false, false));
			_Table.Columns.Add(new Column("Body", DbType.String, typeof (String), "Body", false, false));
			_Table.Columns.Add(new Column("CreatedBy", DbType.String, typeof (String), "CreatedBy", true, false));
			_Table.Columns.Add(new Column("Published", DbType.DateTime, typeof (DateTime), "Published", false, false));
			_Table.Columns.Add(new Column("Name", DbType.String, typeof (String), "Name", false, false));
			_Table.Columns.Add(new Column("IsPublished", DbType.Boolean, typeof (Boolean), "IsPublished", false, false));
			_Table.Columns.Add(new Column("Version", DbType.Int32, typeof (Int32), "Version", false, false));
			_Table.Columns.Add(new Column("WebSite", DbType.String, typeof (String), "WebSite", true, false));
			_Table.Columns.Add(new Column("SpamScore", DbType.Int32, typeof (Int32), "SpamScore", false, false));
			_Table.Columns.Add(new Column("IPAddress", DbType.String, typeof (String), "IPAddress", true, false));
			_Table.Columns.Add(new Column("ModifiedOn", DbType.DateTime, typeof (DateTime), "ModifiedOn", false, false));
			_Table.Columns.Add(new Column("ModifiedBy", DbType.String, typeof (String), "ModifiedBy", true, false));
			_Table.Columns.Add(new Column("Email", DbType.String, typeof (String), "Email", true, false));
			_Table.Columns.Add(new Column("IsDeleted", DbType.Boolean, typeof (Boolean), "IsDeleted", false, false));
			_Table.Columns.Add(new Column("UniqueId", DbType.Guid, typeof (Guid), "UniqueId", false, false));
			_Table.Columns.Add(new Column("UserName", DbType.String, typeof (String), "UserName", true, false));
			_Table.Columns.Add(new Column("IsTrackback", DbType.Boolean, typeof (Boolean), "IsTrackback", false, false));
		}
		...
		{
			Id = DataService.GetValue<Int32>(Columns.Id, reader);
			PostId = DataService.GetValue<Int32>(Columns.PostId, reader);
			Body = DataService.GetValue<String>(Columns.Body, reader);
			CreatedBy = DataService.GetValue<String>(Columns.CreatedBy, reader);
			Published = DataService.GetValue<DateTime>(Columns.Published, reader);
			Name = DataService.GetValue<String>(Columns.Name, reader);
			IsPublished = DataService.GetValue<Boolean>(Columns.IsPublished, reader);
			Version = DataService.GetValue<Int32>(Columns.Version, reader);
			WebSite = DataService.GetValue<String>(Columns.WebSite, reader);
			SpamScore = DataService.GetValue<Int32>(Columns.SpamScore, reader);
			IPAddress = DataService.GetValue<String>(Columns.IPAddress, reader);
			ModifiedOn = DataService.GetValue<DateTime>(Columns.ModifiedOn, reader);
			ModifiedBy = DataService.GetValue<String>(Columns.ModifiedBy, reader);
			Email = DataService.GetValue<String>(Columns.Email, reader);
			IsDeleted = DataService.GetValue<Boolean>(Columns.IsDeleted, reader);
			UniqueId = DataService.GetValue<Guid>(Columns.UniqueId, reader);
			UserName = DataService.GetValue<String>(Columns.UserName, reader);
			IsTrackback = DataService.GetValue<Boolean>(Columns.IsTrackback, reader);
			Loaded();
			ResetStatus();
		...
		public static class Columns
		{
			...
			public static readonly Column PostId = new Column("PostId", DbType.Int32, typeof (Int32), "PostId", false,
			                                                  false);

			public static readonly Column Body = new Column("Body", DbType.String, typeof (String), "Body", false, false);

			public static readonly Column CreatedBy = new Column("CreatedBy", DbType.String, typeof (String), "CreatedBy",
			                                                     true, false);

			public static readonly Column Published = new Column("Published", DbType.DateTime, typeof (DateTime),
			                                                     "Published", false, false);

			public static readonly Column Name = new Column("Name", DbType.String, typeof (String), "Name", false, false);

			public static readonly Column IsPublished = new Column("IsPublished", DbType.Boolean, typeof (Boolean),
			                                                       "IsPublished", false, false);

			public static readonly Column Version = new Column("Version", DbType.Int32, typeof (Int32), "Version", false,
			                                                   false);

			public static readonly Column WebSite = new Column("WebSite", DbType.String, typeof (String), "WebSite", true,
			                                                   false);

			public static readonly Column SpamScore = new Column("SpamScore", DbType.Int32, typeof (Int32), "SpamScore",
			                                                     false, false);

			public static readonly Column IPAddress = new Column("IPAddress", DbType.String, typeof (String), "IPAddress",
			                                                     true, false);

			public static readonly Column ModifiedOn = new Column("ModifiedOn", DbType.DateTime, typeof (DateTime),
			                                                      "ModifiedOn", false, false);

			public static readonly Column ModifiedBy = new Column("ModifiedBy", DbType.String, typeof (String),
			                                                      "ModifiedBy", true, false);

			public static readonly Column Email = new Column("Email", DbType.String, typeof (String), "Email", true, false);
			...
			public static readonly Column UserName = new Column("UserName", DbType.String, typeof (String), "UserName",
			                                                    true, false);

			public static readonly Column IsTrackback = new Column("IsTrackback", DbType.Boolean, typeof (Boolean),
			                                                       "IsTrackback", false, false);
		}
	}
	...
	public partial class Log : DataBuddyBase
	{
		...
		static Log()
		{
			...
			_Table.Columns.Add(new Column("Id", DbType.Int32, typeof (Int32), "Id", false, true));
			_Table.Columns.Add(new Column("Type", DbType.Int32, typeof (Int32), "Type", false, false));
			_Table.Columns.Add(new Column("Title", DbType.String, typeof (String), "Title", false, false));
			_Table.Columns.Add(new Column("Message", DbType.String, typeof (String), "Message", false, false));
			_Table.Columns.Add(new Column("CreatedBy", DbType.String, typeof (String), "CreatedBy", false, false));
			_Table.Columns.Add(new Column("CreatedOn", DbType.DateTime, typeof (DateTime), "CreatedOn", false, false));
		}
		...
		private void Load(IDataReader reader, bool close)
		{
			Id = DataService.GetValue<Int32>(Columns.Id, reader);
			Type = DataService.GetValue<Int32>(Columns.Type, reader);
			Title = DataService.GetValue<String>(Columns.Title, reader);
			Message = DataService.GetValue<String>(Columns.Message, reader);
			CreatedBy = DataService.GetValue<String>(Columns.CreatedBy, reader);
			CreatedOn = DataService.GetValue<DateTime>(Columns.CreatedOn, reader);
			Loaded();
			ResetStatus();
		...
		public static class Columns
		{
			...
			public static readonly Column Title = new Column("Title", DbType.String, typeof (String), "Title", false,
			                                                 false);

			public static readonly Column Message = new Column("Message", DbType.String, typeof (String), "Message", false,
			                                                   false);

			public static readonly Column CreatedBy = new Column("CreatedBy", DbType.String, typeof (String), "CreatedBy",
			                                                     false, false);

			public static readonly Column CreatedOn = new Column("CreatedOn", DbType.DateTime, typeof (DateTime),
			                                                     "CreatedOn", false, false);
		}
	}
	...
	public partial class ObjectStore : DataBuddyBase
	{
		...
		static ObjectStore()
		{
			...
			_Table.Columns.Add(new Column("Id", DbType.Int32, typeof (Int32), "Id", false, true));
			_Table.Columns.Add(new Column("Name", DbType.String, typeof (String), "Name", false, false));
			_Table.Columns.Add(new Column("Data", DbType.String, typeof (String), "Data", false, false));
			_Table.Columns.Add(new Column("Type", DbType.String, typeof (String), "Type", false, false));
			_Table.Columns.Add(new Column("CreatedOn", DbType.DateTime, typeof (DateTime), "CreatedOn", false, false));
			_Table.Columns.Add(new Column("ModifiedOn", DbType.DateTime, typeof (DateTime), "ModifiedOn", false, false));
			_Table.Columns.Add(new Column("Content_Type", DbType.String, typeof (String), "ContentType", false, false));
			_Table.Columns.Add(new Column("Version", DbType.Int32, typeof (Int32), "Version", false, false));
			_Table.Columns.Add(new Column("UniqueId", DbType.Guid, typeof (Guid), "UniqueId", false, false));
		}
		...
		private void Load(IDataReader reader, bool close)
		{
			Id = DataService.GetValue<Int32>(Columns.Id, reader);
			Name = DataService.GetValue<String>(Columns.Name, reader);
			Data = DataService.GetValue<String>(Columns.Data, reader);
			Type = DataService.GetValue<String>(Columns.Type, reader);
			CreatedOn = DataService.GetValue<DateTime>(Columns.CreatedOn, reader);
			ModifiedOn = DataService.GetValue<DateTime>(Columns.ModifiedOn, reader);
			ContentType = DataService.GetValue<String>(Columns.ContentType, reader);
			Version = DataService.GetValue<Int32>(Columns.Version, reader);
			UniqueId = DataService.GetValue<Guid>(Columns.UniqueId, reader);
			Loaded();
			ResetStatus();
		...
		public static class Columns
		{
			public static readonly Column Id = new Column("Id", DbType.Int32, typeof (Int32), "Id", false, true);
			public static readonly Column Name = new Column("Name", DbType.String, typeof (String), "Name", false, false);
			public static readonly Column Data = new Column("Data", DbType.String, typeof (String), "Data", false, false);
			public static readonly Column Type = new Column("Type", DbType.String, typeof (String), "Type", false, false);
			...
			public static readonly Column ContentType = new Column("Content_Type", DbType.String, typeof (String),
	...
	/// </summary>
	[Serializable]
	public class PostStatistic : DataBuddyBase
	{
		private static readonly Table _Table;
		...
		static PostStatistic()
		{
			...
			_Table.Columns.Add(new Column("Id", DbType.Int32, typeof (Int32), "Id", false, true));
			_Table.Columns.Add(new Column("PostId", DbType.Int32, typeof (Int32), "PostId", false, false));
			_Table.Columns.Add(new Column("DateViewed", DbType.DateTime, typeof (DateTime), "DateViewed", false, false));
		}
		...
		private void Load(IDataReader reader, bool close)
		{
			Id = DataService.GetValue<Int32>(Columns.Id, reader);
			PostId = DataService.GetValue<Int32>(Columns.PostId, reader);
			DateViewed = DataService.GetValue<DateTime>(Columns.DateViewed, reader);
			Loaded();
			ResetStatus();
		...
		public static class Columns
		{
			...
			public static readonly Column DateViewed = new Column("DateViewed", DbType.DateTime, typeof (DateTime),
			                                                      "DateViewed", false, false);
		}
	}
	...
	public partial class Post : DataBuddyBase
	{
		...
		static Post()
		{
			...
			_Table.Columns.Add(new Column("Id", DbType.Int32, typeof (Int32), "Id", false, true));
			_Table.Columns.Add(new Column("Title", DbType.String, typeof (String), "Title", false, false));
			_Table.Columns.Add(new Column("PostBody", DbType.String, typeof (String), "PostBody", false, false));
			_Table.Columns.Add(new Column("CreatedOn", DbType.DateTime, typeof (DateTime), "CreatedOn", false, false));
			_Table.Columns.Add(new Column("ModifiedOn", DbType.DateTime, typeof (DateTime), "ModifiedOn", false, false));
			_Table.Columns.Add(new Column("Status", DbType.Int32, typeof (Int32), "Status", false, false));
			_Table.Columns.Add(new Column("Content_Type", DbType.String, typeof (String), "ContentType", false, false));
			_Table.Columns.Add(new Column("Name", DbType.String, typeof (String), "Name", false, false));
			_Table.Columns.Add(new Column("Comment_Count", DbType.Int32, typeof (Int32), "CommentCount", false, false));
			_Table.Columns.Add(new Column("Tag_List", DbType.String, typeof (String), "TagList", true, false));
			_Table.Columns.Add(new Column("CategoryId", DbType.Int32, typeof (Int32), "CategoryId", false, false));
			_Table.Columns.Add(new Column("Version", DbType.Int32, typeof (Int32), "Version", false, false));
			_Table.Columns.Add(new Column("ModifiedBy", DbType.String, typeof (String), "ModifiedBy", true, false));
			_Table.Columns.Add(new Column("CreatedBy", DbType.String, typeof (String), "CreatedBy", true, false));
			_Table.Columns.Add(new Column("ExtendedBody", DbType.String, typeof (String), "ExtendedBody", false, false));
			_Table.Columns.Add(new Column("IsDeleted", DbType.Boolean, typeof (Boolean), "IsDeleted", false, false));
			_Table.Columns.Add(new Column("Published", DbType.DateTime, typeof (DateTime), "Published", false, false));
			_Table.Columns.Add(new Column("Pending_Comment_Count", DbType.Int32, typeof (Int32), "PendingCommentCount",
			                              false, false));
			_Table.Columns.Add(new Column("Views", DbType.Int32, typeof (Int32), "Views", false, false));
			_Table.Columns.Add(new Column("UniqueId", DbType.Guid, typeof (Guid), "UniqueId", false, false));
			_Table.Columns.Add(new Column("EnableComments", DbType.Boolean, typeof (Boolean), "EnableComments", false,
			                              false));
			_Table.Columns.Add(new Column("PropertyKeys", DbType.String, typeof (String), "PropertyKeys", true, false));
			_Table.Columns.Add(new Column("PropertyValues", DbType.String, typeof (String), "PropertyValues", true, false));
			_Table.Columns.Add(new Column("UserName", DbType.String, typeof (String), "UserName", false, false));
			_Table.Columns.Add(new Column("Notes", DbType.String, typeof (String), "Notes", true, false));
			_Table.Columns.Add(new Column("ImageUrl", DbType.String, typeof (String), "ImageUrl", true, false));
			_Table.Columns.Add(new Column("MetaDescription", DbType.String, typeof (String), "MetaDescription", true,
			                              false));
			_Table.Columns.Add(new Column("MetaKeywords", DbType.String, typeof (String), "MetaKeywords", true, false));
			_Table.Columns.Add(new Column("IsPublished", DbType.Boolean, typeof (Boolean), "IsPublished", false, false));
			_Table.Columns.Add(new Column("SortOrder", DbType.Int32, typeof (Int32), "SortOrder", false, false));
			_Table.Columns.Add(new Column("ParentId", DbType.Int32, typeof (Int32), "ParentId", false, false));
			_Table.Columns.Add(new Column("IsHome", DbType.Boolean, typeof (Boolean), "IsHome", false, false));
			_Table.Columns.Add(new Column("HomeSortOrder", DbType.Int32, typeof (Int32), "HomeSortOrder", false, false));
		}
		...
		private void Load(IDataReader reader, bool close)
		{
			Id = DataService.GetValue<Int32>(Columns.Id, reader);
			Title = DataService.GetValue<String>(Columns.Title, reader);
			PostBody = DataService.GetValue<String>(Columns.PostBody, reader);
			CreatedOn = DataService.GetValue<DateTime>(Columns.CreatedOn, reader);
			ModifiedOn = DataService.GetValue<DateTime>(Columns.ModifiedOn, reader);
			Status = DataService.GetValue<Int32>(Columns.Status, reader);
			ContentType = DataService.GetValue<String>(Columns.ContentType, reader);
			Name = DataService.GetValue<String>(Columns.Name, reader);
			CommentCount = DataService.GetValue<Int32>(Columns.CommentCount, reader);
			TagList = DataService.GetValue<String>(Columns.TagList, reader);
			CategoryId = DataService.GetValue<Int32>(Columns.CategoryId, reader);
			Version = DataService.GetValue<Int32>(Columns.Version, reader);
			ModifiedBy = DataService.GetValue<String>(Columns.ModifiedBy, reader);
			CreatedBy = DataService.GetValue<String>(Columns.CreatedBy, reader);
			ExtendedBody = DataService.GetValue<String>(Columns.ExtendedBody, reader);
			IsDeleted = DataService.GetValue<Boolean>(Columns.IsDeleted, reader);
			Published = DataService.GetValue<DateTime>(Columns.Published, reader);
			PendingCommentCount = DataService.GetValue<Int32>(Columns.PendingCommentCount, reader);
			Views = DataService.GetValue<Int32>(Columns.Views, reader);
			UniqueId = DataService.GetValue<Guid>(Columns.UniqueId, reader);
			EnableComments = DataService.GetValue<Boolean>(Columns.EnableComments, reader);
			PropertyKeys = DataService.GetValue<String>(Columns.PropertyKeys, reader);
			PropertyValues = DataService.GetValue<String>(Columns.PropertyValues, reader);
			UserName = DataService.GetValue<String>(Columns.UserName, reader);
			Notes = DataService.GetValue<String>(Columns.Notes, reader);
			ImageUrl = DataService.GetValue<String>(Columns.ImageUrl, reader);
			MetaDescription = DataService.GetValue<String>(Columns.MetaDescription, reader);
			MetaKeywords = DataService.GetValue<String>(Columns.MetaKeywords, reader);
			IsPublished = DataService.GetValue<Boolean>(Columns.IsPublished, reader);
			SortOrder = DataService.GetValue<Int32>(Columns.SortOrder, reader);
			ParentId = DataService.GetValue<Int32>(Columns.ParentId, reader);
			IsHome = DataService.GetValue<Boolean>(Columns.IsHome, reader);
			HomeSortOrder = DataService.GetValue<Int32>(Columns.HomeSortOrder, reader);
			Loaded();
			ResetStatus();
		...
		private Int32 _PendingCommentCount;

		public Int32 PendingCommentCount
		{
			get { return _PendingCommentCount; }
			set
			{
				MarkDirty();
				_PendingCommentCount = value;
			}
		}
		...
		private Int32 _HomeSortOrder;

		public Int32 HomeSortOrder
		{
			get { return _HomeSortOrder; }
			set
			{
				MarkDirty();
				_HomeSortOrder = value;
			}
		}
		...
		public static class Columns
		{
			...
			public static readonly Column PostBody = new Column("PostBody", DbType.String, typeof (String), "PostBody",
			                                                    false, false);
			...
			public static readonly Column Status = new Column("Status", DbType.Int32, typeof (Int32), "Status", false,
			                                                  false);
			...
			public static readonly Column CommentCount = new Column("Comment_Count", DbType.Int32, typeof (Int32),
			                                                        "CommentCount", false, false);

			public static readonly Column TagList = new Column("Tag_List", DbType.String, typeof (String), "TagList", true,
			                                                   false);

			public static readonly Column CategoryId = new Column("CategoryId", DbType.Int32, typeof (Int32), "CategoryId",
			                                                      false, false);
			...
			public static readonly Column ExtendedBody = new Column("ExtendedBody", DbType.String, typeof (String),
			                                                        "ExtendedBody", false, false);
			...
			public static readonly Column PendingCommentCount = new Column("Pending_Comment_Count", DbType.Int32,
			                                                               typeof (Int32), "PendingCommentCount", false,
			                                                               false);

			public static readonly Column Views = new Column("Views", DbType.Int32, typeof (Int32), "Views", false, false);

			public static readonly Column UniqueId = new Column("UniqueId", DbType.Guid, typeof (Guid), "UniqueId", false,
			                                                    false);

			public static readonly Column EnableComments = new Column("EnableComments", DbType.Boolean, typeof (Boolean),
			                                                          "EnableComments", false, false);

			public static readonly Column PropertyKeys = new Column("PropertyKeys", DbType.String, typeof (String),
			                                                        "PropertyKeys", true, false);

			public static readonly Column PropertyValues = new Column("PropertyValues", DbType.String, typeof (String),
			                                                          "PropertyValues", true, false);

			public static readonly Column UserName = new Column("UserName", DbType.String, typeof (String), "UserName",
			                                                    false, false);

			public static readonly Column Notes = new Column("Notes", DbType.String, typeof (String), "Notes", true, false);
			...
			public static readonly Column SortOrder = new Column("SortOrder", DbType.Int32, typeof (Int32), "SortOrder",
			                                                     false, false);

			public static readonly Column ParentId = new Column("ParentId", DbType.Int32, typeof (Int32), "ParentId",
			                                                    false, false);

			public static readonly Column IsHome = new Column("IsHome", DbType.Boolean, typeof (Boolean), "IsHome", false,
			                                                  false);

			public static readonly Column HomeSortOrder = new Column("HomeSortOrder", DbType.Int32, typeof (Int32),
			                                                         "HomeSortOrder", false, false);
		}
	}
	...
	/// </summary>
	[Serializable]
	public class UserRole : DataBuddyBase
	{
		private static readonly Table _Table;
		...
		static UserRole()
		{
			...
			_Table.PrimaryKey = "Id";
			_Table.Columns.Add(new Column("Id", DbType.Int32, typeof (Int32), "Id", false, true));
			_Table.Columns.Add(new Column("UserId", DbType.Int32, typeof (Int32), "UserId", false, false));
			_Table.Columns.Add(new Column("RoleName", DbType.String, typeof (String), "RoleName", false, false));
		}
		...
		{
			Id = DataService.GetValue<Int32>(Columns.Id, reader);
			UserId = DataService.GetValue<Int32>(Columns.UserId, reader);
			RoleName = DataService.GetValue<String>(Columns.RoleName, reader);
			Loaded();
			ResetStatus();
		...
		public static class Columns
		{
			...
			public static readonly Column UserId = new Column("UserId", DbType.Int32, typeof (Int32), "UserId", false,
			                                                  false);

			public static readonly Column RoleName = new Column("RoleName", DbType.String, typeof (String), "RoleName",
			                                                    false, false);
		}
	}
	...
	public partial class User : DataBuddyBase
	{
		...
		static User()
		{
			...
			_Table.Columns.Add(new Column("Id", DbType.Int32, typeof (Int32), "Id", false, true));
			_Table.Columns.Add(new Column("Name", DbType.String, typeof (String), "Name", false, false));
			_Table.Columns.Add(new Column("Email", DbType.String, typeof (String), "Email", false, false));
			_Table.Columns.Add(new Column("ProperName", DbType.String, typeof (String), "ProperName", true, false));
			_Table.Columns.Add(new Column("TimeZoneOffSet", DbType.Double, typeof (Double), "TimeZoneOffSet", false, false));
			_Table.Columns.Add(new Column("Bio", DbType.String, typeof (String), "Bio", true, false));
			_Table.Columns.Add(new Column("Avatar", DbType.String, typeof (String), "Avatar", true, false));
			_Table.Columns.Add(new Column("PublicEmail", DbType.String, typeof (String), "PublicEmail", true, false));
			_Table.Columns.Add(new Column("WebSite", DbType.String, typeof (String), "WebSite", true, false));
			_Table.Columns.Add(new Column("Password", DbType.String, typeof (String), "Password", false, false));
			_Table.Columns.Add(new Column("Password_Salt", DbType.String, typeof (String), "PasswordSalt", false, false));
			_Table.Columns.Add(new Column("PasswordFormat", DbType.Int32, typeof (Int32), "PasswordFormat", false, false));
			_Table.Columns.Add(new Column("UniqueId", DbType.Guid, typeof (Guid), "UniqueId", false, false));
		}
		...
		private void Load(IDataReader reader, bool close)
		{
			...
			Name = DataService.GetValue<String>(Columns.Name, reader);
			Email = DataService.GetValue<String>(Columns.Email, reader);
			ProperName = DataService.GetValue<String>(Columns.ProperName, reader);
			TimeZoneOffSet = DataService.GetValue<Double>(Columns.TimeZoneOffSet, reader);
			Bio = DataService.GetValue<String>(Columns.Bio, reader);
			Avatar = DataService.GetValue<String>(Columns.Avatar, reader);
			PublicEmail = DataService.GetValue<String>(Columns.PublicEmail, reader);
			WebSite = DataService.GetValue<String>(Columns.WebSite, reader);
			Password = DataService.GetValue<String>(Columns.Password, reader);
			PasswordSalt = DataService.GetValue<String>(Columns.PasswordSalt, reader);
			PasswordFormat = DataService.GetValue<Int32>(Columns.PasswordFormat, reader);
			UniqueId = DataService.GetValue<Guid>(Columns.UniqueId, reader);
			Loaded();
			ResetStatus();
		...
		public static class Columns
		{
			...
			public static readonly Column Email = new Column("Email", DbType.String, typeof (String), "Email", false,
			                                                 false);

			public static readonly Column ProperName = new Column("ProperName", DbType.String, typeof (String),
			                                                      "ProperName", true, false);

			public static readonly Column TimeZoneOffSet = new Column("TimeZoneOffSet", DbType.Double, typeof (Double),
			                                                          "TimeZoneOffSet", false, false);

			public static readonly Column Bio = new Column("Bio", DbType.String, typeof (String), "Bio", true, false);

			public static readonly Column Avatar = new Column("Avatar", DbType.String, typeof (String), "Avatar", true,
			                                                  false);

			public static readonly Column PublicEmail = new Column("PublicEmail", DbType.String, typeof (String),
			                                                       "PublicEmail", true, false);

			public static readonly Column WebSite = new Column("WebSite", DbType.String, typeof (String), "WebSite", true,
			                                                   false);

			public static readonly Column Password = new Column("Password", DbType.String, typeof (String), "Password",
			                                                    false, false);

			public static readonly Column PasswordSalt = new Column("Password_Salt", DbType.String, typeof (String),
			                                                        "PasswordSalt", false, false);

			public static readonly Column PasswordFormat = new Column("PasswordFormat", DbType.Int32, typeof (Int32),
			                                                          "PasswordFormat", false, false);
	...
	public partial class VersionStore : DataBuddyBase
	{
		...
		static VersionStore()
		{
			...
			_Table.Columns.Add(new Column("CreatedOn", DbType.DateTime, typeof (DateTime), "CreatedOn", false, false));
			_Table.Columns.Add(new Column("Name", DbType.String, typeof (String), "Name", false, false));
			_Table.Columns.Add(new Column("ItemId", DbType.Int32, typeof (Int32), "ItemId", false, false));
			_Table.Columns.Add(new Column("Notes", DbType.String, typeof (String), "Notes", false, false));
		}
		...
		private void Load(IDataReader reader, bool close)
		{
			...
			CreatedOn = DataService.GetValue<DateTime>(Columns.CreatedOn, reader);
			Name = DataService.GetValue<String>(Columns.Name, reader);
			ItemId = DataService.GetValue<Int32>(Columns.ItemId, reader);
			Notes = DataService.GetValue<String>(Columns.Notes, reader);
			Loaded();
			ResetStatus();
		...
		public static class Columns
		{
			...
			public static readonly Column ItemId = new Column("ItemId", DbType.Int32, typeof (Int32), "ItemId", false,
			                                                  false);

			public static readonly Column Notes = new Column("Notes", DbType.String, typeof (String), "Notes", false,
			                                                 false);
		}
	}
	...
	public partial class TagWeight : DataBuddyBase
	{
		...
		static TagWeight()
		{
			...
			_Table.PrimaryKey = "";
			_Table.Columns.Add(new Column("Name", DbType.String, typeof (String), "Name", false, false));
			_Table.Columns.Add(new Column("WEIGHT", DbType.Int32, typeof (Int32), "Weight", false, false));
		}
		...
		{
			Name = DataService.GetValue<String>(Columns.Name, reader);
			Weight = DataService.GetValue<Int32>(Columns.Weight, reader);
			Loaded();
			ResetStatus();
		...
		public static class Columns
		{
			...
			public static readonly Column Weight = new Column("WEIGHT", DbType.Int32, typeof (Int32), "Weight", false,
			                                                  false);
		}
	}
	...
	/// </summary>
	[Serializable]
	public class RolePermissions : DataBuddyBase
	{
		private static readonly Table _Table;
		...
		static RolePermissions()
		{
			...
			_Table.Columns.Add(new Column("Id", DbType.Int32, typeof (Int32), "Id", false, true));
			_Table.Columns.Add(new Column("RoleName", DbType.String, typeof (String), "RoleName", false, false));
			_Table.Columns.Add(new Column("HasRead", DbType.Boolean, typeof (Boolean), "HasRead", false, false));
			_Table.Columns.Add(new Column("HasEdit", DbType.Boolean, typeof (Boolean), "HasEdit", false, false));
			_Table.Columns.Add(new Column("HasPublish", DbType.Boolean, typeof (Boolean), "HasPublish", false, false));
			_Table.Columns.Add(new Column("CreatedBy", DbType.String, typeof (String), "CreatedBy", true, false));
			_Table.Columns.Add(new Column("ModifiedOn", DbType.DateTime, typeof (DateTime), "ModifiedOn", false, false));
			_Table.Columns.Add(new Column("ModifiedBy", DbType.String, typeof (String), "ModifiedBy", true, false));
		}
		...
		private void Load(IDataReader reader, bool close)
		{
			Id = DataService.GetValue<Int32>(Columns.Id, reader);
			RoleName = DataService.GetValue<String>(Columns.RoleName, reader);
			HasRead = DataService.GetValue<Boolean>(Columns.HasRead, reader);
			HasEdit = DataService.GetValue<Boolean>(Columns.HasEdit, reader);
			HasPublish = DataService.GetValue<Boolean>(Columns.HasPublish, reader);
			CreatedBy = DataService.GetValue<String>(Columns.CreatedBy, reader);
			ModifiedOn = DataService.GetValue<DateTime>(Columns.ModifiedOn, reader);
			ModifiedBy = DataService.GetValue<String>(Columns.ModifiedBy, reader);
			Loaded();
		...
		public static class Columns
		{
			...
			public static readonly Column HasRead = new Column("HasRead", DbType.Boolean, typeof (Boolean), "HasRead",
			                                                   false, false);

			public static readonly Column HasEdit = new Column("HasEdit", DbType.Boolean, typeof (Boolean), "HasEdit",
			                                                   false, false);

			public static readonly Column HasPublish = new Column("HasPublish", DbType.Boolean, typeof (Boolean),
			                                                      "HasPublish", false, false);
	...
	/// </summary>
	[Serializable]
	public class RoleCategoryPermissions : DataBuddyBase
	{
		private static readonly Table _Table;
