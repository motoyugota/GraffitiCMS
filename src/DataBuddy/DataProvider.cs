...
namespace DataBuddy
{
	public abstract class DataProvider
	{
		...
		public virtual string ConnectionString
		{
			...
			{
				return
					ConfigurationManager.ConnectionStrings[ConfigurationManager.AppSettings["DataBuddy::ConnectionString"]]
						.ConnectionString;
			}
		}
		...
		public virtual QueryCommand CreateQueryCommandFromQuery(Query q)
		{
			...
			{
				command.Sql = SelectSql(columnList.ToString(), q.Table.TableName, whereStatement, orderStatement,
				                        q.PageSize.ToString());
			}
			else
			{
		...
		protected virtual string SelectPagedSql(string columnList, string tableName, string where, string order, string pk,
