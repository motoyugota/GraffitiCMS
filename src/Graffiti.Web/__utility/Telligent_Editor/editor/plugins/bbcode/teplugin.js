...
TEConfig.EnterMode = 'br' ;

// To avoid pasting invalid markup (which is discarded in any case), let's
// force pasting to plain text.
TEConfig.ForcePasteAsPlainText	= true ;

// Rename the "Source" buttom to "BBCode".
TEToolbarItems.RegisterItem( 'Source', new TEToolbarButton( 'Source', 'BBCode', null, TE_TOOLBARITEM_ICONTEXT, true, true, 1 ) ) ;
