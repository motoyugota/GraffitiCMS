...
namespace Graffiti.Core
{
	...
	public class StaticAccessorHelper<T> : IDuck
	{
		/// <summary>
		...
		{
			return typeof (T).InvokeMember(propName,
		...
		{
			return typeof (T).InvokeMember(method, BindingFlags.Public | BindingFlags.Static | BindingFlags.InvokeMethod, null,
			                               null, args);
		}
