...
namespace Graffiti.Core
{
	...
	public static class Util
	{
		...
		{
			get { return SiteSettings.Get().PageSize; }
		}
		...
		public static bool CanWrite(HttpContext cntx)
		{
			try
			{
				if (!_canWrite)
				{
					...
					{
						sw.WriteLine(
							"Temporary file generated by Graffiti CMS to test for write access. If you see this file, it is likely your server is not properly configured to support Graffiti. Please see http://graffiticms.codeplex.com/documentation for more help.");
						sw.Close();
					}
		...
		public static string Pager(int pageIndex, int pageSize, int totalRecords, string cssClass, string qs, string older,
								   string newer)
		{
		...
		public static List<string> ConvertStringToList(string itemText)
		{
			...
			{
				var items = itemText.Split(new[] {",", ";"}, StringSplitOptions.RemoveEmptyEntries);
		...
		{
			return
				!Regex.IsMatch(name, "^(" + ConfigurationManager.AppSettings["Graffiti::ExcludedNames"] + ")$",
		...
		public static bool CheckUrlRoutingSupport()
		{
			...
			try
			{
				HttpWebResponse response =
					GRequest.GetResponse(macros.FullUrl(VirtualPathUtility.ToAbsolute("~/__utility/GraffitiUrlRoutingCheck")));
