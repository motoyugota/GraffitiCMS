...
namespace Graffiti.Core
{
	public class RssHandler : IRouteHandler
	{
		...
		{
			string categoryOneName = requestContext.RouteData.Values["categoryone"] != null
				                         ? requestContext.RouteData.Values["categoryone"].ToString()
				                         : null;
			string categoryTwoName = requestContext.RouteData.Values["categorytwo"] != null
				                         ? requestContext.RouteData.Values["categorytwo"].ToString()
				                         : null;
